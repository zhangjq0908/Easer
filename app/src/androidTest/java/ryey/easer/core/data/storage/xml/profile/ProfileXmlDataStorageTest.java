...
public class ProfileXmlDataStorageTest extends ApplicationTestCase<Application> {
    public ProfileXmlDataStorageTest() {
    ...
    public void testProfileXmlDataStorage() throws IOException {
        ...
        ProfileXmlDataStorage dataStorage = ProfileXmlDataStorage.getInstance(getContext());
