...
public class WifiEnabledConditionPlugin implements ConditionPlugin<WifiEnabledConditionData> {
    ...
    @NonNull
    @Override
    public PluginViewFragment<WifiEnabledConditionData> view() {
        return new WifiEnabledPluginViewFragment();
    }
