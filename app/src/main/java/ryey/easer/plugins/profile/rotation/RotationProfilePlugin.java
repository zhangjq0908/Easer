...
public class RotationProfilePlugin implements ProfilePlugin {
    @Override
    public String name() {
    ...
    public SwitchItemLayout view(Context context) {
        return new SwitchItemLayout(context, new RotationContentLayout(context));
    }
