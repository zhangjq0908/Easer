            ...
            try {
                ...
                switch (data.protocol) {
                    case tcp:
                        try {
                            ...
                            try {
                                ...
                                try {
                                    ...
                                    try {
                                        dataOutputStream.writeBytes(data.data.raw);
                                    } finally {
                        ...
                        break;
                    case udp:
                        DatagramPacket datagramPacket = new DatagramPacket(data.data.raw.getBytes(), data.data.raw.length(), remote_address, data.remote_port);
                        try {
